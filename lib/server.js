...
class Server {
  ...
  _setupExpressRoutes() {
    ...
    this.app.use('/accounts', authentication, routers.account)
    this.app.use('/auth', routers.authentication)
    this.app.use('/', routers.status)
    this.app.use('/transactions', authentication, routers.transaction)
    this.app.use('/users', authentication, routers.user)
